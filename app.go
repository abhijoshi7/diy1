...
func (a *App) createProduct(w http.ResponseWriter, r *http.Request) {
	var p product
	//const jsonStream = `{"Name": "Milk", "Price" : 1.2}`
...
func (a *App) initializeRoutes() {
	...
	a.Router.HandleFunc("/store/{id:[0-9]+}/products", a.productList).Methods("GET")
	a.Router.HandleFunc("/store/{id:[0-9]+}", a.addProduct).Methods("POST")
}
